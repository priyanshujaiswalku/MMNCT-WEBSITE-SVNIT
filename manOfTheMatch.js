...
import { updateManOfTheMatch } from "../../components/matchFunctions.js";
...
const UpdateMan= ({ auth_users }) => {
    ...
    const submitData = async (e) => {
        ...
        await updateManOfTheMatch(currId, formData.ManOfTheMatch)
            alert("Man of the Match Updated successfully");
          } catch (error) {
            console.error("Error updating Man of the Match:", error);
            alert("Failed to update Man of the Match");
          }
    };
    ...
    return (
        <div>
            ...
            <div className="overflow-x-auto">
                <p className="text-center my-10 text-3xl">Update man Of The Match </p>
        ...
        <div className="md:w-2/3">
            <p className="text-gray-700"> {team1name} vs {team2name}</p>
        </div>
    </div>
                    ...
                    <div className="md:flex md:items-center mb-6">
                        ...
                        <div className="md:w-2/3">
                            <input
                                ...
                                onChange={(e) => setFormData({ ManOfTheMatch: e.target.value })}
                                required
                            />
                        </div>
                    </div>
